...
namespace BMPTrains_2020.DomainCode
{
    ...
    public class XmlObjectDatabase
    {
        ...
        {
            // This should return the SQL Connection. In some applications this 
            // will come from the web.config file. In other applications, from other 
            // sources
        ...
        #region Select
        public static int ObjectCount(string objectClass)
        {
        ...
        public static DataTable SelectForName(string name)
        {
        ...
        {
            string sql = "SELECT COUNT(*) FROM XmlObject ";
            sql += "WHERE OwnerUserId IN (@OwnerUserID, 'Global') ";
            sql += "AND Class = @Class";
        ...
        public static string Update(IXmlPropertyObject o)
        {
            ...
            using (connection)
            {
                ...
                command.Parameters.Add("@OwnerUserID", SqlDbType.VarChar);
                command.Parameters[parameterName: "@OwnerUserID"].Value = o.Owner;
