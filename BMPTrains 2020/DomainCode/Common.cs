...
namespace BMPTrains_2020.DomainCode
{
    ...
    public class Common
    {
        ...
        public static string GenerateReportTableFromProperties<T>(T item, string tableTitle, params Expression<Func<T, object>>[] properties)
        {
        ...
        public static string GenerateReportTableFromPropertyNames(object obj, string title, string[] propertyNames)
        {
            return GenerateReportTableFromPropertyNames(obj, title, (IEnumerable<string>)propertyNames);
        }
        ...
        public static string GenerateReportTableFromPropertyNames(object obj, string title, IEnumerable<string> propertyNames)
        {
            // The string is the Property Names of the Object that is passed as obj. This allows you to create 
            // a string of the property names and produce a report using an array of the names of the porperties 
            // The meta data for the properties are used for labels and units. 

            if (obj == null) return "<i>null</i>";
            if (propertyNames == null) return GenerateReportTableofAllProperties(obj, title);
        ...
        public static string GenerateReportTableofAllProperties(object obj, string title = null)
        {
            if (obj == null) return "<i>null</i>";
            var sb = new StringBuilder();
            var t = obj.GetType();
